...
| [utils_deep_merge_yaml.addon_values](https://registry.terraform.io/providers/cloudposse/utils/latest/docs/data-sources/deep_merge_yaml) | data source |
...
| <a name="input_cloudwatch_containers_tags"></a> [cloudwatch\_containers\_tags](#input\_cloudwatch\_containers\_tags) | A map of tags to assign to the resource. | `map(any)` |
| <a name="input_cloudwatch_enabled"></a> [cloudwatch\_enabled](#input\_cloudwatch\_enabled) | Variable indicating whether default cloudwatch group with iam role is created and configured as vector sink. | `bool` |
...
| <a name="input_cloudwatch_nodes_tags"></a> [cloudwatch\_nodes\_tags](#input\_cloudwatch\_nodes\_tags) | A map of tags to assign to the resource. | `map(any)` |
...
| <a name="input_loki_enabled"></a> [loki\_enabled](#input\_loki\_enabled) | Variable indicating whether Loki is configured as Vector sink. | `bool` |
| <a name="input_loki_endpoint"></a> [loki\_endpoint](#input\_loki\_endpoint) | Domain-specific endpoint used to submit index and data upload requests. | `string` |
| <a name="input_loki_internal_logs_enabled"></a> [loki\_internal\_logs\_enabled](#input\_loki\_internal\_logs\_enabled) | Whether Vector internal logs should be sent to Loki. | `bool` |
...
| <a name="input_opensearch_default_sinks_enabled"></a> [opensearch\_default\_sinks\_enabled](#input\_opensearch\_default\_sinks\_enabled) | Define if default sinks for kubernetes\_containers and journal should be enabled. | `bool` |
